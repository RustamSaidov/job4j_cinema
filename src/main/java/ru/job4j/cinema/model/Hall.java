...
public class Hall {
    ...
    public boolean equals(Object o) {
        ...
        Hall hall = (Hall) o;
        return getId() == hall.getId() && getRowCount() == hall.getRowCount() && getPlaceCount() == hall.getPlaceCount() && getName().equals(hall.getName()) && getDescription().equals(hall.getDescription());
    }
